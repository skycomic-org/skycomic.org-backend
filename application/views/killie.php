...
<div id="ie8sucks" class="modal fade">
  ...
  <div class="modal-body">
    <p>由於Skycomic採用新技術，已經不再支援舊型的瀏覽器( < IE9 )，因此建議您升級成新款瀏覽器，以獲得最佳體驗。</p>
	...
	<div style="float:left;text-align:center">
    <a target="_blank" href="http://tw.opera.com/">
    	<img width="128" src="<?= base_url('image/iesucks/opera.png') ?>" alt=""><br>
    	Opera
	</a>
	</div>
	<div style="float:left;text-align:center">
    <a target="_blank" href="http://windows.microsoft.com/zh-tw/internet-explorer/downloads/ie-9/worldwide-languages">
    	<img width="128" src="<?= base_url('image/iesucks/ie.png') ?>" alt=""><br>
    	IE9
	</a>
	</div>
